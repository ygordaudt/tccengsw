      ...
      <div class="heroSection__content container q-mb-xl">
        <div class="row full-width q-mb-xl">
          <div class="col-12 col-md-6 vertical-middle self-center">
            <h2 class="text-h3 text-white text-weight-medium fredoka">TCC Eng Sw.</h2>
            ...
            <hover v-slot="{hoverIsActive}">
              <q-card :class="{ 'shadow-6 cursor-pointer': hoverIsActive }">
                <q-card-section class="text-center">
                  ...
                  <h5 class="text-h4 q-my-md">Funcionalidade X</h5>
                  <p class="text-gray text-subtitle1 text-justify">Descrição da funcionalidade X do projeto. Descrição da funcionalidade X do projeto. Descrição da funcionalidade X do projeto</p>
                </q-card-section>
              </q-card>
            </hover>
          </div>
          <div class="col-12 col-md-4">
            <hover v-slot="{hoverIsActive}">
              <q-card :class="{ 'shadow-6 cursor-pointer': hoverIsActive }">
                <q-card-section class="text-center">
                  <q-avatar size="70px" class="bg-primary text-white" icon="bolt"></q-avatar>
                  <h5 class="text-h4 q-my-md">Funcionalidade Y</h5>
                  <p class="text-gray text-subtitle1 text-justify">Descrição da funcionalidade Y do projeto. Descrição da funcionalidade Y do projeto. Descrição da funcionalidade Y do projeto</p>
                </q-card-section>
              </q-card>
            </hover>
          </div>
          <div class="col-12 col-md-4">
            <hover v-slot="{hoverIsActive}">
              <q-card :class="{ 'shadow-6 cursor-pointer': hoverIsActive }">
                <q-card-section class="text-center">
                  <q-avatar size="70px" class="bg-primary text-white" icon="bolt"></q-avatar>
                  <h5 class="text-h4 q-my-md">Funcionalidade Z</h5>
                  <p class="text-gray text-subtitle1 text-justify">Descrição da funcionalidade Z do projeto. Descrição da funcionalidade Z do projeto. Descrição da funcionalidade Z do projeto</p>
                </q-card-section>
              </q-card>
            </hover>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-md-6 self-center text-right">
            <h2 class="text-h3 text-weight-thin fredoka">Sobre nós</h2>
